...
# include "lib/asio/asio/detail/socket_select_interrupter.hpp"
#elif defined(ASIO_HAS_EVENTFD)
# include "lib/asio/asio/detail/eventfd_select_interrupter.hpp"
#else
# include "lib/asio/asio/detail/pipe_select_interrupter.hpp"
#endif
